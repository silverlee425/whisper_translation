...
def main():
    ...
    parser.add_argument("--host", type=str, help="Server address", default='127.0.0.1')
    parser.add_argument("--port", type=int, help="Server port number", default=8000)
    ...
    while True:
        try:
            ...
            text = gtranslate.translate(text, 'ko').result
            print(text)
            try:
                data = sock.send(text)
